 ...
 * V3.1: Added options for mode and timeout
 */
async function executeRealDiscovery(
  config: Config, 
  runId: string, 
  profileHash: string,
  options: { mode: DiscoveryMode; timeout: number } = { mode: 'smoke', timeout: DEFAULT_TIMEOUT_SECONDS }
...
function generateMarkdownReport(brief: ConnectionBrief, config: Config): string {
  ...
  lines.push('---\n');
  lines.push(`*Generated by clawbridge-runner v3.1.0*`);
